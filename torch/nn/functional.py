...
avg_pool2d = _add_docstr(torch.avg_pool2d, r"""
...
avg_pool3d = _add_docstr(torch.avg_pool3d, r"""
...
def _max_pool2d(input, kernel_size, stride=None, padding=0, dilation=1,
    ...
    if stride is None:
        ...
        _stride = torch.jit._unwrap_optional(stride)
    return torch.max_pool2d(input, kernel_size, _stride, padding, dilation, ceil_mode)
...
def max_pool3d_with_indices(input, kernel_size, stride=None, padding=0,
    ...
    if stride is None:
        ...
        _stride = torch.jit._unwrap_optional(stride)
    return torch._C._nn.max_pool3d_with_indices(input, kernel_size, _stride, padding, dilation, ceil_mode)
...
def _max_pool3d(input, kernel_size, stride=None, padding=0, dilation=1,
    ...
    if stride is None:
        ...
        _stride = torch.jit._unwrap_optional(stride)
    return torch.max_pool3d(input, kernel_size, _stride, padding, dilation, ceil_mode)
